...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) { // AMD
        ...
        module.exports = factory(require('lodash'), root); // Node/Browserify
    } else {
        factory(root._, root); // Browser
    }
    ...
    //export EJSON based on environment
    if (typeof(module) !== 'undefined' && module.exports) {
        ...
        var _previousRoot = root.EJSON;

        // **`noConflict()` - (browser only) to reset global 'EJSON' var**
        EJSON.noConflict = function() {
            root.EJSON = _previousRoot;
            return EJSON;
        };
